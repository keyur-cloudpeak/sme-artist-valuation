    ...
    function renderTabbar() {
      ...
      const moveResume = `<form action="/api/auth/resume" method="POST" target="_top" style="margin:0 10px 0 0; flex:0 0 auto;"><input type="hidden" name="action" value="move_resume" /><button class="btn secondary" type="submit">Back To Welcome</button></form>`;
