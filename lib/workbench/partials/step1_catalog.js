    ...
    function renderScreen1() {
      ...
      if (mode === "Artist") {
        ...
        <input type="text" id="searchTermSel" value="${esc(state.searchTerm)}" placeholder="Type artist name..." autocomplete="off"
        ...
        <input type="text" id="searchTermSel" value="${esc(state.searchTerm)}" placeholder="Type label name..." autocomplete="off"
          oninput="acInputChanged('searchTermSel')"
          style="font-size:1.15rem; padding:14px; border-radius:12px;">
    </div>`;
      } else {
